...
module TicTacToe
  RSpec.describe Board do
    ...
    context "#game_over" do
      ...
      it "returns :winner when row has objects with values are all the same" do
        grid = [
      ...
      it "returns :winner when column has objects with values are all the same" do
        grid = [
      ...
      it "returns :winner when diagnoal has objects with values are all the same" do
        grid = [
          [y_cell, x_cell, x_cell],
          [y_cell, x_cell, y_cell],
          [x_cell, y_cell, empty]
